...
features <- train[,c(-8:-11)]#dropping 11 which is the target variable, salary
...
varImp(xx_mdl)
# education-num, marital-status,age, and capital-gain, and capital-loss are the best ones to use
...
education-num
# is this how many years total or after high school?
```
